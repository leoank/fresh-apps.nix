...
We compare the package set on the PR head against the base branch and require
every attribute that exists on head but not on base to declare at least one
maintainer. Existing packages with empty maintainers are grandfathered.
"""
